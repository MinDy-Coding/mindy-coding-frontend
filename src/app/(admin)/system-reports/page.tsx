  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Quản lý Hệ thống & Báo cáo</h1>
          <p className="text-gray-600 mt-1">Cấu hình hệ thống, log và báo cáo phân tích</p>
        </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-3">
                          ...
                          <div>
                            ...
                            <span className="ml-2 text-sm font-medium">{classItem.staff || "Chưa cập nhật"}</span>
                          </div>
                        </div>
                        ...
                        <div className="space-y-3">
                          <div>
                            ...
                            <span className="ml-2 text-sm font-medium">{classItem.revenue || "Chưa phân công"}</span>
                          </div>
                          <div>
